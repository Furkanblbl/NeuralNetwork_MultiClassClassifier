...
Item {
    ...
    property real default_widget_border_size: 5
    readonly property string default_widget_text_color: "white"
    readonly property string default_widget_back_color: "#626270"
}
